...
export default function MeditationsPage() {
  ...
  const page = getPage("meditations");
  return (
    <>
      <PageHero title="OSHO Dynamic Meditation" copy="A powerful morning practice that uses breath, movement, catharsis, silence, and celebration to awaken awareness." label="Dynamic Meditation Hero" image={page.heroImage} imageAlt={page.heroAlt ?? "OSHO Dynamic Meditation at the Mystery School"} accent="terracotta" />
