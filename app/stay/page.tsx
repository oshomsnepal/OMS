...
export default function StayPage() {
  ...
  return (
    <>
      <PageHero title="Stay Close to Silence" copy="Wake with the mountain light, meditate with the community, and let the day unfold at a gentler pace." label="Stay Hero Image" accent="forest"><Button href="/visit">Inquire About a Stay</Button></PageHero>
      ...
      <section className="section container relative space-y-28 overflow-hidden"><SectionOrnament motif="lotus" position="top-left" tone="sage" opacity={0.3}/><div className="relative z-10 grid items-center gap-16 lg:grid-cols-2"><div><SectionHeading eyebrow="Shared practice" title="Meditation Spaces" /><p className="lede">The heart of the school is its meditation space—a place for energetic morning practices, music, dancing, and deep evening silence.</p></div><ResponsiveImage label="Meditation Hall Image" aspect="1 / 1" placeholderTone="sage" className="rounded-[8px]" /></div><div className="relative z-10 grid items-center gap-16 lg:grid-cols-2"><ResponsiveImage label="Garden and Dining Image" aspect="4 / 3" className="rounded-[8px] lg:order-1" /><div className="lg:order-2"><SectionHeading eyebrow="Everyday life" title="Gardens, Meals & Community" /><p className="lede">Unhurried meals and outdoor spaces create natural opportunities to meet people—or simply be alone.</p></div></div></section>
