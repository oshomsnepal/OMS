...
export function Button({ href, children, variant = "primary", className = "" }: Props) {
  const styles = {
    primary: "bg-[var(--terracotta-bright)] !text-white shadow-[0_10px_30px_rgba(154,68,42,.22)] hover:-translate-y-0.5 hover:bg-[var(--terracotta)] hover:!text-white hover:shadow-[0_14px_34px_rgba(154,68,42,.3)]",
